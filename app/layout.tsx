...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Northline — Make the website match the work", description: "Strategy, design, motion, and development for digital experiences that feel clear, dimensional, and premium.", url: "/", siteName: "Northline", type: "website", locale: "en_US" },
  twitter: { card: "summary_large_image", title: "Northline — Make the website match the work", description: "Strategy, design, motion, and development for websites and digital products built around clarity, depth, and action." },
